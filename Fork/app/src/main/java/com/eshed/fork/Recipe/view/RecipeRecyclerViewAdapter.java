...
import com.eshed.fork.Recipe.view.ViewHolders.CommentFooterViewHolder;
...
public class RecipeRecyclerViewAdapter extends RecyclerView.Adapter<RecipeViewHolder> implements RecipeViewModel.Listener, FooterCallback {
    ...
    public interface RecipeAdapterHandler {
        ...
        void addCommentComponent(RecipeViewModel vm);
    }
    ...
    public RecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (type) {
            ...
            case Footer_Comment:
                view = inflater.inflate(R.layout.item_footer, parent, false);
                CommentFooterViewHolder commentFooterViewHolder = new CommentFooterViewHolder(view);
                commentFooterViewHolder.callback = this;
